                                ...
                                <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                    ...
                                    <div class="fix-bottom product-sticky-content sticky-content">
                                        <div class="product-form container">
                                            ...
                                            <button wire:click="addToCart()" class="btn btn-primary btn-cart">
                        ...
                        <div class="tab tab-nav-boxed tab-nav-underline product-tabs">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="product-tab-vendor">
                                        ...
                                        <div class="col-md-6 pl-2 pl-md-6 mb-4">
                                            ...
                                            <ul class="vendor-info list-style-none">
                                                ...
                                                <li class="store-address">
                                                    <label>Address:</label>
                                                    <span class="detail">Steven Street, El Carjon, CA 92020,
                                                        United
                                                        States (US)</span>
                                                </li>
                                    ...
                                    <p class="mb-5"><strong class="text-dark">L</strong>orem ipsum
                                        dolor sit amet,
                                    ...
                                    <p class="mb-2"><strong class="text-dark">A</strong> arcu cursus
                                        vitae congue
