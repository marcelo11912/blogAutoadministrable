                ...
                <div wire:ignore>
                    ...
                    <form class="login-content">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.lazy="email" type="text" class="form-control form-control-md @error('email') is-invalid @enderror" name="name" required="">
                                    @error('email')
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model.lazy="password" type="password" class="form-control form-control-md @error('password') is-invalid @enderror" name="password" required="">
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-group checkbox">
                            <input wire:model="remember" type="checkbox" class="custom-checkbox" id="remember" name="remember">
                            ...
                            <div class="row gutter-sm">
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <input wire:model.lazy="billing_first_name" type="text" class="form-control form-control-md" name="firstname" required="">
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        <label>Last name *</label>
                                        <input wire:model.lazy="billing_last_name" type="text" class="form-control form-control-md" name="lastname" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Company name (optional)</label>
                                <input wire:model.lazy="billing_company" type="text" class="form-control form-control-md" name="company-name">
                            </div>
                            <div class="form-group">
                                <label>Country / Region *</label>
                                <div class="select-box">
                                    <select wire:change="getStates()" wire:model="billing_country_region" name="country" class="form-control form-control-md">
                            ...
                            <div class="row gutter-sm">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>State *</label>
                                        <div class="select-box">
                                            <select wire:change="getCities()" wire:model="billing_state"  name="country" class="form-control form-control-md">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>City *</label>
                                        <div class="select-box">
                                            <select wire.model="billing_town_city" name="country" class="form-control form-control-md">
                                                <option value="default" selected="selected">Seleccionar la ciudad</option>
